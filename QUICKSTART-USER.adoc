...
// Replace manifesto, Manifesto — See README.adoc for details., just run, Manifesto started successfully. with actuals
= manifesto — Quick Start for Users
:toc:
:toclevels: 2

== What is manifesto?

Manifesto — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./manifesto-portable
----
...
[source]
----
Manifesto started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/manifesto/wiki
