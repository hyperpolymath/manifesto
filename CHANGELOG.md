...
All notable changes to `manifesto` will be documented in this file.
...
- fix(ci): bump a2ml/k9-validate-action pins to canonical (standards#85) (#8)
...
- fix(ci): move secret-scanner Cargo.toml gate from job-level if: to step-level (#3)
...
- docs: update manifesto for post-consolidation era
...
- ci: redistribute concurrency-cancel guard to read-only check workflows (#10)
